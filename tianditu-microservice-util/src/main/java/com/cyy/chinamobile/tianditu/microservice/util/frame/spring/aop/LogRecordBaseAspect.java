package com.cyy.chinamobile.tianditu.microservice.util.frame.spring.aop;
...
import com.cyy.chinamobile.tianditu.microservice.util.common.ClassUtil;
...
public abstract class LogRecordBaseAspect {
	...
	// 定义切点Pointcut
	@Pointcut("execution(public * com..chinamobile.demo.microservice..*.controller.*Controller.*(..))")
